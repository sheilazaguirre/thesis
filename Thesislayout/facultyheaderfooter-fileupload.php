<?php
  ...
  $query_select = "SELECT DISTINCT(c.classID), b.blockCode FROM classes c
...
$result2 = $con->query($query_select) or die(mysqli_error($con));
$list_sections = "";
while ($row = mysqli_fetch_array($result2))
{
  ...
  $blockCode = $row['blockCode'];
    ...
    if(isset($_POST['submit']))
    {
      ...
      $class = mysqli_real_escape_string($con, $_POST['classID']);
      $desc = mysqli_real_escape_string($con, $_POST['lessonDesc']);
      $file = mysqli_real_escape_string($con, $_POST['lessonFile']);
  
      $sql_add = "INSERT INTO assignments VALUES ('', $title, '$class', '$desc',
			'$newFile', NOW(), NULL, 'NOW() + INTERVAL 6 Month, 'Active')";
	...
	<div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        <div class="well well-sm">
          ...
          <fieldset>
            <legend class="text-center">Add Lesson</legend>
            ...
            <div class="form-group">
            <label class="col-md-3 control-label" for="name">ClassID</label>
            <div class="col-md-9">
