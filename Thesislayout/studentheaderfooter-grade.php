<?php 
	include 'config.php';
	$query = "SELECT b.blockCode, s.subjectCode, CONCAT(t.startTime, '-', t.endTime, ' ', t.dayOfWeek) as timesched, v.venueCode, cs.midtermGrade, cs.finalGrade FROM classes c 
