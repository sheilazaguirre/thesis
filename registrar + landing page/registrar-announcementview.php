...
<?php 
	...
	$sql = "SELECT announceID, announceTitle, announceDetail, announceFile, status FROM announcements";
...
<div id="wrap">
            ...
            <div class="col-lg-6 text-right">
                <a href="registrar-announcementadd.php" class="btn btn-danger">
					Add
				</a>
            </div>
				<table cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered">
					<thead>
						<tr>
							<th bgcolor="#a9404d">Announcement ID</th>
							<th bgcolor="#a9404d">Title</th>
							<th bgcolor="#a9404d">Detail</th>
							<th bgcolor="#a9404d">File</th>
							<th bgcolor="#a9404d">Status</th>
							<th bgcolor="#a9404d"></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><?php echo "AnnounceID :{$row['announceID']}" ?></td>
							<td><?php echo "AnnounceTitle :{$row['announceTitle']}" ?></td>
							<td><?php echo "AnnounceDetail :{$row['announceDetail']}" ?></td>
							<td><?php echo "AnnounceFile :{$row['announceFile']}" ?></td>
