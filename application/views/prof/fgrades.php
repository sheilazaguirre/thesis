<?php
	...
	$result = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='1' AND classID='".$classID."'");
	$result1 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='1.25' AND classID='".$classID."'");
	$result2 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='1.50' AND classID='".$classID."'");
	$result3 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='1.75' AND classID='".$classID."'");
	$result4 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='2' AND classID='".$classID."'");
	$result5 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='2.25' AND classID='".$classID."'");
	$result6 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='2.50' AND classID='".$classID."'");
	$result7 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='2.75' AND classID='".$classID."'");
	$result8 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='3' AND classID='".$classID."'");
	$result9 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='4' AND classID='".$classID."'");
	$result10 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='W' AND classID='".$classID."'");
	$result11 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='X' AND classID='".$classID."'");
	$result12 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='inc' AND classID='".$classID."'");
	var_dump($dump);
			...
			<div id="studentContent">
				<div class="container">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<select name="grade[<?=$c['classlistID']?>]" <?php if ($c['status'] == 'FSubmitted'){ ?> disabled <?php   } ?> required />
										<option value="" <?php if($c["fgrade"] == '') echo "selected"; else echo ""; ?>>Select Grade</option>
										<option value="1" <?php if($c["fgrade"] == 1) echo "selected"; else echo ""; ?>>1.00</option>
										<option value="1.25" <?php if($c["fgrade"] == 1.25) echo "selected"; else echo ""; ?>>1.25</option>
										<option value="1.50" <?php if($c["fgrade"] == 1.50) echo "selected"; else echo ""; ?>>1.50</option>
										<option value="1.75" <?php if($c["fgrade"] == 1.75) echo "selected"; else echo ""; ?>>1.75</option>
										<option value="2" <?php if($c["fgrade"] == 2) echo "selected"; else echo ""; ?>>2.00</option>
										<option value="2.25" <?php if($c["fgrade"] == 2.25) echo "selected"; else echo ""; ?>>2.25</option>
										<option value="2.50" <?php if($c["fgrade"] == 2.50) echo "selected"; else echo ""; ?>>2.50</option>
										<option value="2.75" <?php if($c["fgrade"] == 2.75) echo "selected"; else echo ""; ?>>2.75</option>
										<option value="3" <?php if($c["fgrade"] == 3) echo "selected"; else echo ""; ?>>3.00</option>
										<option value="5" <?php if($c["fgrade"] == 5) echo "selected"; else echo ""; ?>>5.00</option>
										<option value="W" <?php if($c["fgrade"] == "W") echo "selected"; else echo ""; ?>>W</option>
										<option value="X" <?php if($c["fgrade"] == "X") echo "selected"; else echo ""; ?>>X</option>
										<option value="inc" <?php if($c["fgrade"] == "inc") echo "selected"; else echo ""; ?>>INC</option>
									</select>
									<br/>
								</td>
								<td>
									<textarea <?php if ($c['status'] == 'FSubmitted'){ ?> disabled <?php   } ?> name="remarks[<?=$c['classlistID']?>]">
										<?php echo $c['remarks']; ?>
									</textarea>
								</td>
					...
					<div class="form-group">
						...
						<?php if($classlist[0]['status'] != 'FSubmitted'): ?>
