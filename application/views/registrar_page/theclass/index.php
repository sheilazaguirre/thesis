    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
            	...
            	<div class="box-tools">
                    <a href="<?php echo site_url('reg_theclass/add'); ?>" class="btn btn-success btn-sm">Add Class</a> 
                </div>
            </div>
            <div class="box-body">
                ...
                <thead>
                    ...
                    <tr>
						...
						<td>
                            <a href="<?php echo site_url('reg_theclass/edit/'.$c['classID']); ?>" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Edit</a> 
                            <a href="<?php echo site_url('reg_theclass/remove/'.$c['classID']); ?>" class="btn btn-danger btn-xs"><span class="fa fa-trash"></span> Delete</a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
