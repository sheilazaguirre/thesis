    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Class Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="facultyID" value="<?php echo $this->input->post('facultyID'); ?>" class="form-control" id="facultyID" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="timeSlotID" class="control-label">TimeSlotID</label>
						<div class="form-group">
							<input type="text" name="timeSlotID" value="<?php echo $this->input->post('timeSlotID'); ?>" class="form-control" id="timeSlotID" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="venueID" class="control-label">VenueID</label>
						<div class="form-group">
							<input type="text" name="venueID" value="<?php echo $this->input->post('venueID'); ?>" class="form-control" id="venueID" />
						</div>
					</div>
					<div class="col-md-6">
