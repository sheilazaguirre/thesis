      	...
      	<div class="box box-info">
			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="venueType" class="form-control">
								<option value="">Seledt a Venuetype</option>
								<?php 
					...
					<div class="col-md-6">
						<label for="venueCode" class="control-label"><span class="text-danger">*</span>Venue Code</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="venueName" class="control-label"><span class="text-danger">*</span>Venue Name</label>
						<div class="form-group">
