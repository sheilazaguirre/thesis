...
if (isset($_REQUEST['no']))
	{
		...
		$query = "SELECT assignTitle, assignDesc,
			assignFile FROM assignments
			WHERE assignID=" . $_REQUEST['no'];

		$results = $con->query($query) or die(mysqli_error($con));
		...
		if (mysqli_num_rows($results) > 0)
		{
			...
			{
			 	$title = mysqli_real_escape_string($con, $_POST['assignTitle']);
	 			$desc = mysqli_real_escape_string($con, $_POST['assignDesc']);
			 	$file = mysqli_real_escape_string($con, $_POST['assignFile']);

				$query_update = "UPDATE assignments SET 
					assignTitle='" . $title . "', 
					assignDesc='" . $desc . "',
					assignFile='" . $file . "',
					dateModified='" . NOW() . "'
				...
				header('location: facultyheaderfooter-AssignmentVIEW.php');
			}
		}
		else
		{
	...
	<div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        <div class="well well-sm">
          ...
          <fieldset>
            <legend class="text-center">Update Assignment</legend>
			...
			<div class="form-group">
              <label class="col-md-3 control-label" for="name">Section</label>
              <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <textarea class="form-control" id="message" name="message" rows="5" value='<?php echo $title; ?>'></textarea>
              </div>
            </div>
			 ...
			 <div class="input-group image-preview">
			  ...
			  <div class="col-md-9">
                <input type="text" class="form-control image-preview-filename" value='<?php echo $file; ?>' disabled="disabled"> <!-- don't give a name === doesn't send on POST/GET -->
                <span class="input-group-btn">
                    ...
                    <div class="btn btn-default image-preview-input">
                        ...
                        <input type="file" accept="application/msword, application/pdf, application/ms-powerpoint, application/ms-excel" name="input-file-preview"/> <!-- rename it -->
						</div>
                    </div>
                </span>
