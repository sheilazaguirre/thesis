		...
		<div id="pageContent">			
			...
			<section class="content">
				<div class="container">
					<!-- title -->
					<div class="title-box">
						<h2 class="text-center title-under">Secondary Education</h2>
					</div>
					<!-- /title -->
					<div class="row">
						<div class="col-md-4 col-sm-12 col-xs-12">
							<a class="link-img-hover1" href="seced_filipino" target="_blank"><img src="<?php echo site_url('resources/my-images/filipino.jpg')?>" class="img-responsive" alt=""></a>							
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
									<span class="font22 text-uppercase color-custom">Major in Filipino</span>
								</a>
							</p>
							<p>Click picture to see details.</p>
						</div>
						<div class="col-md-4 col-sm-12 col-xs-12">
							<a class="link-img-hover1" href="seced_science" target="_blank"><img src="<?php echo site_url('resources/my-images/science.png')?>" class="img-responsive" alt=""></a>
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
									<span class="font22 text-uppercase color-custom">Major in Science</span>
								</a>
							</p>
							<p></p>
						</div>
						<div class="col-md-4 col-sm-12 col-xs-12">
							<a class="link-img-hover1" href="seced_math" target="_blank"><img src="<?php echo site_url('resources/my-images/math.jpg')?>" class="img-responsive" alt=""></a>
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
									<span class="font22 text-uppercase color-custom">Major in Math</span>
								</a>
							</p>
							<p> </p>
						</div>
