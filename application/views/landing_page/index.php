...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="gapc-favicon.ico">
					...
					<ul>
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							...
							<div class="tp-caption lfl stb" 
								...
								<a href="listing.html" class="link-button button--border-thick" data-text="Shop now!">Click Here</a>
							</div>
						</li>
						<!-- /SLIDE -1 -->
						<!-- SLIDE 2  -->            
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
								...
								<div class="text-center"><a href="listing.html" class="link-button button--border-thick" data-text="Shop now!">APPLY NOW</a></div>
							</div>	
			...
			<h1 class="text-center">Sign in to your account</h1>
				...
				<form method="POST" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div>
							<a href="forgotpass.html" name="signin"
								>
								Forgot Password?
							</a>
						</div>
