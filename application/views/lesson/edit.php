			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="lessonDesc" value="<?php echo ($this->input->post('lessonDesc') ? $this->input->post('lessonDesc') : $lesson['lessonDesc']); ?>" class="form-control" id="lessonDesc" />
